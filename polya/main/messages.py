...
# tags
MODULE, MODULE_PAD, DEF, DEF_FULL, ASSERTION, ASSERTION_FULL, MISC, DEBUG = range(8)

# predefined levels
quiet = ()
modules = (MODULE,)
low = (MODULE, MODULE_PAD, DEF, ASSERTION)
normal = (MODULE, MODULE_PAD, DEF, DEF_FULL, ASSERTION, ASSERTION_FULL)
debug = (MODULE, MODULE_PAD, DEF, DEF_FULL, ASSERTION, ASSERTION_FULL, DEBUG)
